...
public class ModClientConfig
{
    ...
    public static final ModConfigSpec.ConfigValue<Boolean> USE_CUSTOM_MAPPINGS;
    public static final ModConfigSpec.ConfigValue<Boolean> TOGGLE_MOUSE_FOCUS;
    public static final ModConfigSpec.ConfigValue<Boolean> AUTO_RESET_MOUSE_FOCUS;
    public static final ModConfigSpec.ConfigValue<Integer> CONFIG_BUTTON_MAIN_MENU_ROW;
    public static final ModConfigSpec.ConfigValue<Integer> CONFIG_BUTTON_MAIN_MENU_OFFSET;
